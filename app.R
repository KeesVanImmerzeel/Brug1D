# Time-dependent head and flow in a semi-infinite aquifer adjacent to open water 
# where the boundary condition changes from t = 0 according to a specified course.
# The equation therefore describes one-dimensional flow for a situation with 
...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel("Documentation",
             h3("Time-dependent head and flow in a semi-infinite aquifer adjacent to open water"),
             p("Author: C.H. van Immerzeel"),
             p(paste("Date:", Sys.Date())),
             p("Time-dependent head and flow in a semi-infinite aquifer adjacent to open water 
        where the boundary condition changes from t = 0 according to a specified course.
        The equation therefore describes one-dimensional flow for a situation with 
        spatially constant kD and S, without recharge (precipitation, evaporation, leakage).
        From: 'Van Edelman naar Bruggeman', Stromingen 12 (2006)")
